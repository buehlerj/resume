    ...
    this.projects = [
      {
        ...
        description1: `This is a project that I've been working on for a few years now. It
        ...
        descriptionImage1: '/SWLib/SWLibPhase1.png',
        description2: `Using my experience as an Angular dev, I created a website with the
        ...
        description3: `The project expanded to include other rankings that I had made,
        ...
        descriptionImage3: '/SWLib/SWLibPhase3.png',

        description4: `I went about 2 years without updating any of my rankings due to how
        ...
        descriptionImage4: '/SWLib/SWLibPhase4.png',
      },
      {
        ...
        description1: `As mentioned above, I created this ExpressJS API to access the data
              ...
              in .json files.`,
        descriptionImage1: '/SWLib/API.png',
      },
      {
        ...
        description1: `I have been building computers since before I was in college, and
        ...
        descriptionImage1: '/companies/noco_custom_pcs.png',
      },
      {
        label: 'Pie Calculator',
        githubLink: 'https://github.com/buehlerj/pie-calculator',
        technologies: [{ label: 'Ionic', icon: 'tech/ionic.png' }],
        description1: `A silly idea that my old roomate's father in law pitched to me on
